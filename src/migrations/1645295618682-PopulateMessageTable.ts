...
export class PopulateMessageTable1645295618682 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('DELETE FROM public.message');
  }
}
